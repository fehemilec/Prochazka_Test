...
export default function Horiz() {
  ...
  const getFinalPrice = () => {
    let final_price =
      (getPriceCount() +
        Number((hor / 1000).toFixed(2) * (ver / 1000).toFixed(2) * priceProf) +
        Number((hor / 1000).toFixed(2) * (ver / 1000).toFixed(2) * priceLam)) *
      amount;
          ...
          <div className="infoCol">
            <div className="info">
              <div className="info_Text">
                Přicházíme na trh s novou generací ISOLINE žaluzií. Tato žaluzie
                je koncepčně novým nástupcem generace žaluzií ISOLINE a ISOLINE
                LOCO. Spojuje v sobě všechny technické přednosti těchto typů.
                Díky spojení horního profilu a krycí lišty v jeden celek vzniklo
                kompaktní řešení, které odstraňuje neduhy předchozích generací.
                Je ovládaná řetízkem a nabízí tradiční barevnou škálu odstínů
                lamel, barevného sladění horního a dolního profilu.
                <br />
                <br />
                Horizontální žaluzie stále představují nejrozšířenější způsob
                protisluneční ochrany a staly se nedílnou součástí interiéru,
                ochraňují nejen proti slunečním paprskům, regulují světlo v
                místnosti, ale chrání i vaše soukromí. Využití horizontálních
                žaluzií je mnohostranné a jejich barevná škála dovoluje
                harmonicky sladit barvy v místnosti s barevnými doplňky a
                vytvořit tak příjemnou atmosféru dle vašeho vkusu. Výhodou je
                jejich jednoduchost, rychlost montáže, minimální údržba a cenová
                dostupnost.
                <br />
                <br />
                Horizontální žaluzii lze zaměřit pomocí návodu.
                <br />
                Šíře výrobku je šíře lamel, horní držáky přesahují tuto šíři na
                každé straně o 35 mm.
                <br />
                <br />
                Důležitá je hloubka zasklívací lišty. V případě, že je menší nez
                19 mm, je nutné doobjednat speciální vymezovací podložky.
                Žaluzie se musí v okně volně pohybovat!
                <br />
                <br />
                <b>
                  Pozor některá okna nemusí být zcela rovná, měřte proto šířku v
                  různých výškách.
                </b>
                <br />
                <br />
              ...
              <div className="manual_and_contact">
                <span>
                  Pro správné určení rozměrů se podívejte na{" "}
                  <a className="first_link" href="https://www.google.com/">
                    video návod
                  </a>{" "}
                  nebo si přečtěte{" "}
                  <a className="second_link" href="https://www.google.com/">
                    návod zaměření
                  </a>
                  .
                  <br />
                  Pokud si chcete objednat zaměření naším technikem, pak nás
                  neváhejte{" "}
                  <a className="third_link" href="https://www.google.com/">
                    kontaktovat
                  </a>
                  .
                </span>
              ...
              <div className="ph_contact">
                <span className="contact_span">
                  Nevíte si rady se zaměřením? Máte jiný požadavek? <br />{" "}
                  Volejte <b>+420 777 292 384</b>
                </span>
                ...
                <ul>
                  <li className="link_one">
                    ...
                    <a href="https://www.google.com/">
                      Video návod na zaměření
                    </a>
                  </li>
                  <li>
                    <i className="fa fa-caret-right"></i>{" "}
                    <a href="https://www.google.com/">Video návod na montáž</a>
                  </li>
                  <li className="link_three">
                    <i className="fa fa-caret-right"></i>{" "}
                    <a href="https://www.google.com/">
                      Návod na zaměření [PDF]
                    </a>
                  </li>
                  <li>
                    <i className="fa fa-caret-right"></i>{" "}
                    <a href="https://www.google.com/">Návod na údržbu</a>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="brzda">
              ...
              <label htmlFor="brzda" className="hodnota">
                <span className="nazev">
                  Brzda (zastaví žaluzii v požadované poloze/zabrání samovolnému
                  sjíždění)
                  <span className="cena">
                    <br /> +25 CZK{" "}
                  </span>
      ...
      <div className="pallete_container">
        <div className="pallete1" onChange={handleLamellaColor}>
          <div className="titleBar_1">
            <span className="palleteTitle">
              {" "}
              <i className="fas fa-paint-roller"></i>ZÁKLADNÍ BARVY
            </span>
          </div>
          <div className="subPallete1">
            <div className="palleteshh">
              ...
              <div>
                <label>
                  <div
                    className="label_class_3"
                    onClick={pop_up_stříbrná_hladká}
                  />
                  <div className="hh">
                    <input
                      type="radio"
              ...
              <div>
                <label>
                  <div
                    className="label_class_4"
                    onClick={pop_up_perleťová_stříbrná}
                  />
                  <div className="hh">
                    <input
                      type="radio"
              ...
              <div>
                <label>
                  <div
                    className="label_class_5"
                    onClick={pop_up_metalická_stříbrná}
                  />
                  <div className="hh">
                    <input
                      type="radio"
              ...
              <div>
                <label>
                  <div
                    className="label_class_6"
                    onClick={pop_up_matná_slonová_kost}
                  />
                  <div className="hh">
                    <input
                      type="radio"
              ...
              <div>
                <label>
                  <div
                    className="label_class_7"
                    onClick={pop_up_lesklá_slonová_kost}
                  />
                  <div className="hh">
                    <input
                      type="radio"
              ...
              <div>
                <label>
                  <div
                    className="label_class_8"
                    onClick={pop_up_matná_bílé_kafe}
                  />
                  <div className="hh">
                    <input
                      type="radio"
              ...
              <div>
                <label>
                  <div
                    className="label_class_9"
                    onClick={pop_up_lesklá_bílé_kafe}
                  />
                  <div className="hh">
                    <input
                      type="radio"
              ...
              <div>
                <label>
                  <div
                    className="label_class_10"
                    onClick={pop_up_matná_béžová}
                  />
                  <div className="hh">
                    <input
                      type="radio"
              ...
              <div>
                <label>
                  <div
                    className="label_class_11"
                    onClick={pop_up_matná_světle_béžová}
                  />
                  <div className="hh">
                    <input
                      type="radio"
              ...
              <div>
                <label>
                  <div
                    className="label_class_18"
                    onClick={pop_up_lesklá_světle_modrá}
                  />
                  <div className="hh">
                    <input
                      type="radio"
              ...
              <div>
                <label>
                  <div
                    className="label_class_19"
                    onClick={pop_up_perletově_světla_modrá}
                  />
                  <div className="hh">
                    <input
                      type="radio"
              ...
              <div>
                <label>
                  <div
                    className="label_class_21"
                    onClick={pop_up_metalická_modrá}
                  />
                  <div className="hh">
                    <input
                      type="radio"
              ...
              <div>
                <label>
                  <div
                    className="label_class_22"
                    onClick={pop_up_lesklá_modrá}
                  />
                  <div className="hh">
                    <input
                      type="radio"
              ...
              <div>
                <label>
                  <div
                    className="label_class_23"
                    onClick={pop_up_lesklá_růžová}
                  />
                  <div className="hh">
                    <input
                      type="radio"
              ...
              <div>
                <label>
                  <div
                    className="label_class_24"
                    onClick={pop_up_perletově_růžová}
                  />
                  <div className="hh">
                    <input
                      type="radio"
              ...
              <div>
                <label>
                  <div
                    className="label_class_25"
                    onClick={pop_up_lesklá_červená}
                  />
                  <div className="hh">
                    <input
                      type="radio"
              ...
              <div>
                <label>
                  <div
                    className="label_class_26"
                    onClick={pop_up_metalická_zelenomodrá}
                  />
                  <div className="hh">
                    <input
                      type="radio"
              ...
              <div>
                <label>
                  <div
                    className="label_class_27"
                    onClick={pop_up_lesklá_pastelová_zelená_hrášková}
                  />
                  <div className="hh">
                    <input
                      type="radio"
                      name="palleteInput"
                      id="27"
                      value="lesklá pastelová zelená/hrášková"
                      onClick={form27}
                    />
              ...
              <div>
                <label>
                  <div
                    className="label_class_28"
                    onClick={pop_up_lesklá_zelená}
                  />
                  <div className="hh">
                    <input
                      type="radio"
              ...
              <div>
                <label>
                  <div
                    className="label_class_29"
                    onClick={pop_up_lesklá_žlutá}
                  />
                  <div className="hh">
                    <input
                      type="radio"
              ...
              <div>
                <label>
                  <div
                    className="label_class_30"
                    onClick={pop_up_lesklá_světle_hnědá}
                  />
                  <div className="hh">
                    <input
                      type="radio"
              ...
              <div>
                <label>
                  <div
                    className="label_class_32"
                    onClick={pop_up_metalická_šedohnědá}
                  />
                  <div className="hh">
                    <input
                      type="radio"
              ...
              <div>
                <label>
                  <div
                    className="label_class_33"
                    onClick={pop_up_perletová_šedohnědá_světlá}
                  />
                  <div className="hh">
                    <input
                      type="radio"
                      name="palleteInput"
                      id="33"
                      value="perleťová šedohnědá světlá"
                      onClick={form33}
                    />
          ...
          <div className="titleBar_1">
            ...
            <span className="amount">
              <span id="amount_sp"> 0 </span> Kč / m<sup>2</sup>
            </span>
          </div>
          <div className="subPallete2">
            <div className="palleteshh1">
              ...
              <div>
                <label>
                  <div
                    className="label_class_49"
                    onClick={pop_up_performovaná_bílá}
                  />
                  <div className="hh">
                    <input
                      type="radio"
              ...
              <div>
                <label>
                  <div
                    className="label_class_50"
                    onClick={pop_up_performovaná_stříbrná}
                  />
                  <div className="hh">
                    <input
                      type="radio"
              ...
              <div>
                <label>
                  <div
                    className="label_class_51"
                    onClick={pop_up_performovaná_béžová}
                  />
                  <div className="hh">
                    <input
                      type="radio"
              ...
              <div>
                <label>
                  <div
                    className="label_class_52"
                    onClick={pop_up_performovaná_šedá}
                  />
                  <div className="hh">
                    <input
                      type="radio"
              ...
              <div>
                <label>
                  <div
                    className="label_class_53"
                    onClick={pop_up_performovaná_slonová_kost}
                  />
                  <div className="hh">
                    <input
                      type="radio"
                      name="palleteInput"
                      id="53"
                      value="perforovaná slonová kost"
                      onClick={form53}
                    />
              ...
              <div>
                <label>
                  <div
                    className="label_class_58"
                    onClick={pop_up_tělová_matná}
                  />
                  <div className="hh">
                    <input
                      type="radio"
        ...
        <div className="titleBar_1">
          <div className="p_title">
            <i className="fas fa-paint-roller"></i>
            <span className="palleteTitle">
              BARVA HORNÍHO A DOLNÍHO PROFILU
            </span>
          </div>
          <span className="amount">
            <span id="amount_2"> 0 </span> Kč / bm
          </span>
        </div>
              ...
              <label>
                ...
                <div className="hh">
                  <input
                    ...
                    name="palleteInput1"
                    id="78"
                    value="perleť červené zlato 0700"
                    onClick={form78}
                  />
        ...
        <div className="formOptions">
          <div className="formCol">
            <div className="col">
              ...
              <select
                onChange={(e) => handleChange_Provedeni(e.target.value)}
                name="sel[1]"
              >
              ...
              <span className="info">
                (více naleznete v sekci TECHNICKÝ POPIS)
              </span>
            </div>
            <div className="col">
              <span className="colLabel">Barva žebříčků</span>
              <select
                onChange={(e) => handleChange_Barva(e.target.value)}
                name="sel[2]"
              >
                <option value="shodná s barvou lamely">
                  shodná s barvou lamely
                </option>
            ...
            <div className="col">
              ...
              <select
                onChange={(e) => handleChange_Okno(e.target.value)}
                name="sel[3]"
              >
              ...
              <span className="info">
                Dle materiálu okna se přikládá vhodný spojovací materiál.
              </span>
            </div>
            <div className="col">
              <span className="colLabel">Podložky</span>
              <select
                onChange={(e) => handleChange_Podlozky(e.target.value)}
                name="sel[4]"
              >
            ...
            <div className="col">
              ...
              <span className="info">
                zdarma (2.5 mm do plastových oken, 4 mm do dřevěných oken)
              </span>
            </div>
          </div>
        </div>
        <div className="priceandsubmit">
          <div className="ps">
            ...
            <label htmlFor="btnSubmit" className="btnSubmit">
              <span className="addToCart" onClick={addToCartHandler_hor}>
                VLOŽIT DO KOŠÍKU
              </span>
            </label>
          </div>
